...
export default {
  ...
  categoryPage: {
    hero: {
      ...
      bg: "/assets/heroes/hero-servers.jpg",
    ...
    brands: [
      {
        ...
        banner: "/assets/banners/dell-servers.jpg",
        ...
        preview: [{ name: "R650", image: "/assets/products/servers/dell-r650.jpg" }],
        to: "/products/server-and-storages/dell-emc",
      },
      {
        slug: "hpe",
        name: "HPE ProLiant / Alletra",
        logo: "/assets/brands/hpe.svg",
        banner: "/assets/banners/hpe-servers.jpg",
        ...
        preview: [{ name: "DL380 Gen11", image: "/assets/products/servers/hpe-dl380.jpg" }],
        to: "/products/server-and-storages/hpe",
      },
      {
        slug: "synology",
        name: "Synology NAS",
        logo: "/assets/brands/synology.svg",
        banner: "/assets/banners/synology.jpg",
        ...
        preview: [{ name: "RS3621xs+", image: "/assets/products/storage/synology-rs3621.jpg" }],
  ...
  brandPages: {
      ...
      models: [
        {
          slug: "poweredge-r650",
          name: "PowerEdge R650",
          image: "/assets/products/servers/dell-r650.jpg",
        ...
        },
        {
          ...
          image: "/assets/products/storage/dell-powerstore.jpg",
    ...
    hpe: {
      hero: {
        ...
        bg: "/assets/banners/hpe-servers.jpg",
      ...
      models: [
        {
          ...
          image: "/assets/products/servers/hpe-dl380.jpg",
    ...
    synology: {
      hero: {
        ...
        bg: "/assets/banners/synology.jpg",
      ...
      models: [
        {
          slug: "rs3621xs-plus",
          name: "RS3621xs+",
          image: "/assets/products/storage/synology-rs3621.jpg",
  ...
  modelPages: {
    "dell-emc": {
      "poweredge-r650": {
        ...
        related: [
          { href: "/products/server-and-storages/hpe/proliant-dl380", name: "HPE DL380 Gen11", image: "/assets/products/servers/hpe-dl380.jpg" },
        ],
      },
      "powerstore-500": {
        hero: {
        ...
        related: [{ href: "/products/server-and-storages/synology/rs3621xs-plus", name: "Synology RS3621xs+", image: "/assets/products/storage/synology-rs3621.jpg" }],
      },
    },
    hpe: {
      "proliant-dl380": {
        ...
        related: [{ href: "/products/server-and-storages/dell-emc/poweredge-r650", name: "Dell R650", image: "/assets/products/servers/dell-r650.jpg" }],
      },
    },
    synology: {
      "rs3621xs-plus": {
        ...
        related: [{ href: "/products/server-and-storages/dell-emc/powerstore-500", name: "PowerStore 500T", image: "/assets/products/storage/dell-powerstore.jpg" }],
      },
    },
  },
